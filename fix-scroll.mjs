...
/* 1. CSS RESET UNTUK MENGHILANGKAN GARIS PUTIH & MEMBUKA KEMBALI SCROLL */
@layer base {
  * {
    margin: 0;
    padding: 0;
  ...
  html {
    ...
    padding: 0 !important;
    overflow-x: hidden;
    overflow-y: scroll; /* Memastikan scroll vertikal selalu aktif dan normal */
...
fs.writeFileSync(path.join(process.cwd(), 'src', 'index.css'), css, 'utf8');
console.log('✅ Scroll berhasil dibuka kembali dan garis putih tetap hilang!');
